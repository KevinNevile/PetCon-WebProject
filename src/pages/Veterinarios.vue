<template>
    <q-page padding>
      <q-table :title="'Veterinarios (' + rows.length + ')'" :rows="rows" :columns="columns" row-key="id">
        ...
        <template v-slot:top>
          <span class="text-h5">Veterinários <span class="text-h6" style="color: rgb(167, 167, 167);">({{ rows.length
          }})</span></span>
          <q-space />
          <div class="q-pa-md">
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      const rows = ref([
        { cpf: 1, nome: 'Kevin', sobrenome: 'Neve', email: 'kevin@teste.com', contato: '123456', status: 'Disponível'},
        { cpf: 2, nome: 'John', sobrenome: 'Andersen', email: 'john@teste.com', contato: '12345', status: 'Indisponível'},
        { cpf: 3, nome: 'Daniel', sobrenome: 'Pontoglio', email: 'daniel@teste.com', contato: '1234', status: 'Disponível'},
        { cpf: 4, nome: 'Luana', sobrenome: 'Chefia', email: 'luana@teste.com', contato: '123', status: 'Indisponível'},
      ])
